...
*------------------------------------------------------------------------------------------*
* Objetivo do Programa: Programa em C para demonstrar a ocupação de um tabuleiro de xadrez *
* Data - 26/08/2024                                                                        * 
* Autor: Kauan Torres                                                                      *
*------------------------------------------------------------------------------------------*/
...
int main() {
	...
	for (x = 0; x < 64; x++) {
        strcpy(tabuleiro[x], "X"); //Adicionando um X em todas as casas, para posteriormente completa-lás
    }
